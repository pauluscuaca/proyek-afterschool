...
{
	public function datapendaftarAction(request $Request)
    {   
        $em = $this->getDoctrine()->getEntityManager();
       
        $datapendaftar = $this->getDoctrine()
                ->getRepository('adminBundle:DataPendaftaran')
                ->findAll();
        $datamurid = $this->getDoctrine()
                ->getRepository('muridBundle:murid')
                ->findAll();
      return $this->render('adminBundle:Pendaftar:datapendaftar.html.twig', array('pendaftar'=>$datapendaftar, 'murid'=>$datamurid));
    }    

   public function deletependaftarAction(Request $request)
    {
       
                $id_pndftr = $request->query->get('id_pndftr');
                $em = $this->getDoctrine()->getManager();
                $user = $em->getRepository('homeBundle:user')->find($id_pndftr);
